...
YU-ADMIN🌻 是一款开源的后台管理平台模板，基于 Vue3、Vite、TypeScript、Pinia、Pinia持久化插件、Unocss 和 ElementPlus等前端最新技术栈。相较于其他比较流行的后台管理模板，更加简洁、快捷和容易理解，对萌新小白十分友好。此项目学习成本非常低含有相关代码注释以及大量的案例，非常适合企业级项目、中小型项目、个人项目以及毕业设计。后续将用户、角色、菜单、字典管理和通用管理平台页面依次编写，做到直接对接后端接口即可，使之快速开发。主题有常见的明亮和暗黑模式，如果有好看的其他主题可提issus，常见的组件有小伙伴提供可提issus会依次封装进去展示。
...
> 入群需要支付66元后加 QQ：1736306607 后截图。

收费主要原因：

1、YU-ADMIN🌻管理平台源码是开源的，喜欢白嫖的直接star和fork即可。

2、作者平常工作比较繁忙，对于喜欢白嫖的家人们的问题，太多也没时间回答。所以不如针对一部分愿意支付买知识的人（可指导毕业设计和工作）。

3、服务器和域名维护每年需要Money。

4、支付入群可提供前端管理平台、uniapp，后端JAVA，Minio、OSS、微信支付、退款，支付支付和退款等相关问题回答，闲暇时间也可以一对一提供帮助。

<table>
    <tr>
        <td><img src="https://koi-fish.oss-cn-beijing.aliyuncs.com/koi/screen/images/wx.jpg"/></td>
